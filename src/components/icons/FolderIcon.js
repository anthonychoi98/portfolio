        ...
        return (
            ...
            <div className="foldericon">
                <Draggable
                    ...
                    <div className="ficon" onMouseEnter={this.handleMouseEnter} onMouseLeave={this.handleMouseLeave} style={{backgroundColor: this.state.tint, opacity: this.state.op}} onClick={this.clickHandler} alt="" ></div>
